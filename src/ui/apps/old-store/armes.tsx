...
const ArmePage = () => {
    ...
    const [weaponSelected, setWeaponSelected] = useState({
        name: "sig550",
        label: "SIG 550",
        img: "https://cdn.discordapp.com/attachments/1035939186051653785/1035970580681326763/sig550.png",
        price: 2500,
    });
        ...
        return (
            <div className="container" onClick={() => setWeaponSelected(props)}>
                ...
                <div style={{width: "100%", display: "flex", justifyContent: "center", alignItems: "center"}}>
                    <img style={{ margin: "15px 0 0 0", height: 90 }} src={ImgWeapons[props.img] || props.img} />
                </div>
            </div> 
        );
    }
            ...
            <div className="container">
                ...
                <div className="it-2">
                    <div style={{position: "absolute", zIndex: 1}}>
                        <img style={{ height: 250, marginLeft: -200 }} src={ImgWeaponsTall[weaponSelected.img] || weaponSelected.img} />
                    </div>
