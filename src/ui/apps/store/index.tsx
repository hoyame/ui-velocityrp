				...
				<div className="groupe-1">
					<div className="flex-row">
						<div className="vehicles" onClick={() => history.push('/cardealer')}>
							...
							<img
								style={{ width: 720, marginLeft: -50 }}
								src="https://cdn.discordapp.com/attachments/749017234743099423/1013834732775157841/unknown_12.png"
							/>
						</div>
						...
						<div>
							<div className="container">
								...
								<img
									style={{ marginTop: -25, marginRight: -40, height: 160 }}
									src="https://cdn.discordapp.com/attachments/749017234743099423/1013898832549003284/unknown_18.png"
								/>
							</div>
							...
							<div className="objets" style={{ paddingRight: 0 }} onClick={() => interact('items')}>
								...
								<img
									...
									src="https://cdn.discordapp.com/attachments/749017234743099423/1013871696563937374/unknown.png"
								/>
							</div>
						</div>
					</div>
					...
					<div className="flex-row">
						<div className="starterpack" onClick={() => interact("starterpack")}>
							...
							<img
								className="anim-loop"
								style={{ height: 240 }}
								src="https://cdn.discordapp.com/attachments/749017234743099423/1013884953177624586/unknown_14.png"
							/>
						</div>
						...
						<div className="bagpack" onClick={() => interact("backpack")}>
							...
							<img
								...
								src="https://cdn.discordapp.com/attachments/749017234743099423/1021069749339304046/unknown_16.png"
							/>
						</div>
						...
						<div className="cash" onClick={() => interact("cash")}>
							...
							<img
								style={{ height: 165 }}
								src="https://cdn.discordapp.com/attachments/749017234743099423/1013895829737705572/unknown.png"
							/>
						</div>
					</div>
				</div>
				...
				<div className="vip" onClick={() => interact("vip")}>
					...
					<div className="content">
						...
						<img
							...
							src="https://cdn.discordapp.com/attachments/749017234743099423/1013904160325914644/unknown_20.png"
						/>
					</div>
				</div>
			</div>
