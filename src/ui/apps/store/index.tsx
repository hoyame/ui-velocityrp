        ...
        <div id='store'>
            <div style={{alignItems: 'center', justifyContent: 'space-between', width: '100%'}} className="flex-row header">
                <div className='flex-row'>               
                    <svg style={{marginRight: 10}} width="50" height="50" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M70.4406 23.3333C69.8646 22.3354 69.0398 21.5038 68.0467 20.9196C67.0536 20.3354 65.926 20.0186 64.7739 20H22.1072L20.1739 12.4667C19.9786 11.7395 19.5428 11.0998 18.9375 10.6519C18.3322 10.204 17.5931 9.97422 16.8406 10H10.1739C9.28985 10 8.44201 10.3512 7.81689 10.9763C7.19177 11.6014 6.84058 12.4493 6.84058 13.3333C6.84058 14.2174 7.19177 15.0652 7.81689 15.6904C8.44201 16.3155 9.28985 16.6667 10.1739 16.6667H14.3072L23.5072 50.8667C23.7026 51.5939 24.1384 52.2335 24.7437 52.6814C25.3489 53.1293 26.088 53.3591 26.8406 53.3333H56.8406C57.4561 53.3315 58.0592 53.1592 58.5828 52.8356C59.1064 52.512 59.5302 52.0497 59.8072 51.5L70.7406 29.6333C71.2145 28.6401 71.4351 27.5449 71.3827 26.4456C71.3304 25.3463 71.0067 24.2771 70.4406 23.3333ZM54.7739 46.6667H29.3739L23.9406 26.6667H64.7739L54.7739 46.6667Z" fill="#769D59"/>
                        <path d="M25.1739 70C27.9353 70 30.1739 67.7614 30.1739 65C30.1739 62.2386 27.9353 60 25.1739 60C22.4125 60 20.1739 62.2386 20.1739 65C20.1739 67.7614 22.4125 70 25.1739 70Z" fill="#769D59"/>
                        <path d="M58.5072 70C61.2686 70 63.5072 67.7614 63.5072 65C63.5072 62.2386 61.2686 60 58.5072 60C55.7458 60 53.5072 62.2386 53.5072 65C53.5072 67.7614 55.7458 70 58.5072 70Z" fill="#769D59"/>
                    </svg>

                    <p>BOUTIQUE</p>

                    <svg style={{margin: '0 40px'}} width="4" height="58" viewBox="0 0 4 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="content">
                <div className="groupe-1">
                    <div className="flex-row">          
                        <div className="vehicles">
                            <div className="flex-row" style={{width: '100%', justifyContent: 'space-between'}}>
                                ...
                                <p style={{fontSize: 15, width: 100, textAlign: 'center', color: 'rgba(255, 255, 255, 0.75)'}}>Possêder une voiture unique</p>
                            </div>

                            <img style={{width: 720, marginLeft: -50}} src='https://cdn.discordapp.com/attachments/749017234743099423/1013834732775157841/unknown_12.png' />
                        </div>
                        ...
                        <div>
                            <div className="container">
                                ...
                                <img style={{marginTop: -25, marginRight: -40, height: 160}} src="https://cdn.discordapp.com/attachments/749017234743099423/1013898832549003284/unknown_18.png" />
                            ...
                            <div className="objets" style={{paddingRight: 0}}>
                                ...
                                <img style={{marginTop: -44, height: 170}} src="https://cdn.discordapp.com/attachments/749017234743099423/1013871696563937374/unknown.png" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-row">
                        <div className="starterpack">
                            <div className='box-text'>
                                ...
                                <div className="flex-row">
                                    <svg width="24" height="24" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.1739 23.8333C19.157 23.8333 24.0072 18.983 24.0072 13C24.0072 7.01687 19.157 2.16663 13.1739 2.16663C7.19082 2.16663 2.34058 7.01687 2.34058 13C2.34058 18.983 7.19082 23.8333 13.1739 23.8333Z" stroke="#80B852" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M16.4239 17.3333L13.8087 14.7182C13.4024 14.3119 13.174 13.7609 13.1739 13.1863V6.5" stroke="#80B852" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                            ...
                            <img className="anim-loop" style={{height: 240}} src="https://cdn.discordapp.com/attachments/749017234743099423/1013884953177624586/unknown_14.png" />
                        </div>
                        ...
                        <div className="cash">
                            ...
                            <img style={{height: 165}} src="https://cdn.discordapp.com/attachments/749017234743099423/1013895829737705572/unknown.png" />
                        </div>
                    </div>
                </div>
                ...
                <div className="vip">
                    ...
                    <div className="content">
                        ...
                        <img style={{marginTop: -30, height: 270}} src='https://cdn.discordapp.com/attachments/749017234743099423/1013904160325914644/unknown_20.png'/>
                    </div>
                </div>
