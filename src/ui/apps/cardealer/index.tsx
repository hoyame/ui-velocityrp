		...
		<div className="cardealer">
			<div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "19%" }}>
				...
				<div className="vehicleList">
					<div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
						<svg
							onClick={() => {
								catIndex == 0 ? setCatIndex(categories.length - 1) : setCatIndex(catIndex - 1);
						...
						>
							<path
								d="M0.348633 8.6543C0.348633 8.96191 0.462891 9.22559 0.708984 9.4541L7.54688 16.1514C7.74023 16.3447 7.98633 16.4502 8.27637 16.4502C8.85645 16.4502 9.32227 15.9932 9.32227 15.4043C9.32227 15.1143 9.19922 14.8594 9.00586 14.6572L2.84473 8.6543L9.00586 2.65137C9.19922 2.44922 9.32227 2.18555 9.32227 1.9043C9.32227 1.31543 8.85645 0.858398 8.27637 0.858398C7.98633 0.858398 7.74023 0.963867 7.54688 1.15723L0.708984 7.8457C0.462891 8.08301 0.348633 8.34668 0.348633 8.6543Z"
								fill="#fff"
							/>
						</svg>
						...
						<svg
							onClick={() => {
								catIndex + 1 < categories.length ? setCatIndex(catIndex + 1) : setCatIndex(0);
								setSelectedVehicle(-1);
							}}
							width="10"
							height="17"
				...
				<div className="vehicle-container">
					{v.map((v, k) => {
						return (
							<div
								className={selectedVehicle == k ? "vehicle-component-selected" : "vehicle-component"}
								onClick={() => {
							...
							>
								...
								{props.store ? (
									<div style={{ display: "flex", flexDirection: "row" }}>
										<p>{v[2]}</p>
										<img
											style={{ height: 16, marginTop: 1, marginLeft: 4 }}
											src="https://cdn.discordapp.com/attachments/857379508747239425/974799289211580506/unknown.png"
										/>
									</div>
								) : (
									<p>{v[2]} $</p>
			...
			<div style={{ position: "absolute", right: 10, top: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
				<div style={{ height: 60, width: 200, display: "flex", alignItems: "center", justifyContent: "center" }}>
					...
					<p style={{ fontSize: 20 }}>Pour quitter</p>
				</div>
				...
				<div style={{ display: "flex", alignItems: "center", marginRight: 15 }}>
					...
					<img
						style={{ height: 25, marginTop: 2, marginLeft: 7.5 }}
						src="https://cdn.discordapp.com/attachments/857379508747239425/974799289211580506/unknown.png"
					/>
				</div>
			</div>
