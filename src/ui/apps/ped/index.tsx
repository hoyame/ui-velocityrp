        ...
        <div id="ped">
            ...
            <div className="content">
                <div className="container">
                    {  state.message &&
                        <svg style={{marginBottom: 30}} width="436" height="97" viewBox="0 0 436 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.5 7C14.5 3.13401 17.634 0 21.5 0H428.5C432.366 0 435.5 3.13401 435.5 7V89.4917C435.5 93.3609 432.361 96.4963 428.492 96.4917L14.5 96L0 96.5L12.3622 84.5641C13.7284 83.245 14.5 81.4274 14.5 79.5283V7Z" fill="rgba(0, 0, 0, 0.5)"/>
