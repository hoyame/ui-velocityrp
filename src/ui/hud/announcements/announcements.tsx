                                ...
                                announcement.advanced && !props.inUI && (
                                    <>
                                        <div className="announcement-header">
                                            <img className="banner" src={announcement.url ? announcement.url : "https://cdn.discordapp.com/attachments/857379508747239425/969621675698180164/unknown.png"} />
                                        </div>
                                    </>
                                )
                            }
