...
export abstract class Store {
	...
	private static async generateCase(source: number, selectedCase: string) {
		...
		const algo = () => {
			...
			l4.push(tEpique[Math.randomRange(0, (tEpique.length - 1) / 2)]);
			l4.push(tEpique[Math.randomRange(0, tEpique.length - 1)]);
			l3.push(tUnique[Math.randomRange(0, tRare.length - 1)]);
			l3.push(tUnique[Math.randomRange(0, tRare.length - 1)]);
			l3.push(tUnique[Math.randomRange(0, tRare.length - 1)]);
			l2.push(tRare[Math.randomRange(0, tRare.length - 1)]);
			l2.push(tRare[Math.randomRange(0, tRare.length - 1)]);
			l2.push(tRare[Math.randomRange(0, tRare.length - 1)]);
			l2.push(tRare[Math.randomRange(0, tRare.length - 1)]);
			l2.push(tRare[Math.randomRange(0, tRare.length - 1)]);
			l1.push(tCommon[Math.randomRange(0, tCommon.length - 1)]);
			l1.push(tCommon[Math.randomRange(0, tCommon.length - 1)]);
			l1.push(tCommon[Math.randomRange(0, tCommon.length - 1)]);
			l1.push(tCommon[Math.randomRange(0, tCommon.length - 1)]);
			l1.push(tCommon[Math.randomRange(0, tCommon.length - 1)]);
