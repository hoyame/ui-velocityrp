...
const actions = {
	...
	appelsDeleteHistorique({ commit, state }, { numero }) {
		...
		commit(
			...
			state.appelsHistorique.filter(h => {
				return h.num !== numero;
			})
		);
	},
...
if (process.env.NODE_ENV !== "production") {
	...
	state.appelsHistorique = [
		{ id: 1, incoming: 0, num: "336-4557", owner: "336-4557", accepts: 0, time: 1528374759000 },
		{ id: 2, incoming: 0, num: "police", owner: "336-4557", accepts: 1, time: 1528374787000 },
		{ id: 3, incoming: 1, num: "555-5555", owner: "336-4557", accepts: 1, time: 1528374566000 },
