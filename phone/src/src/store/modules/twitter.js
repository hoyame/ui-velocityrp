...
if (process.env.NODE_ENV !== "production") {
	state.favoriteTweets = [
		...
		},
		{
			id: 2,
			message:
				"Re-Ignited Roleplay finally in development, Something that needed to be done AGES ago is finally happening, Check out the updates as they exceed expectations ➜ https://discord.gg/K2pR3UC  ",
