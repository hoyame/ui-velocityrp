<template>
	<div class="phone_content">
		...
		<div class="tweets-wrapper" ref="elementsDiv">
			<div class="tweet" v-for="(tweet, key) in tweets" v-bind:key="tweet.id" v-bind:class="{ select: key === selectMessage }">
				<div class="tweet-img">
					<img
						:src="tweet.authorIcon || 'html/static/img/twitter/default_profile.png'"
				...
				<div class="tweet-content">
					<div class="tweet-head">
						<div>
							...
							<div class="tweet-head-author-are">@{{ tweet.author }}</div>
						</div>
					...
					<div class="tweet-like">
						<div class="item svgreply" @click.stop="reply(tweet)">
							<svg @click.stop="reply(tweet)" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
						...
						<div v-if="tweet.isLikes" class="item svgdislike" @click.stop="twitterToogleLike({ tweetId: tweet.id })">
							...
							<span class="likenb" @click.stop="twitterToogleLike({ tweetId: tweet.id })">{{ tweet.likes }}</span>
						</div>
						...
						<div class="item">
							<svg class="iconsvg" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
								<path fill="none" d="M0 0h24v24H0V0z" />
								<path
