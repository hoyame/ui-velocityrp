	...
	<div style="width: 3234px; height: 742px; background: white" class="phone_app">
		...
		<div class="phone_content">
			<div class="elements" ref="elementsDiv">
				<div class="element" v-for="elem in notesMessages" v-bind:key="elem.id">
			...
			<div class="notes_write">
				<CustomInput type="text" placeholder="..." v-model="message" @keyup.enter.prevent="sendMessage" />
...
export default {
	components: { PhoneTitle, CustomInput },
	data() {
		return {
			message: "",
			channel: "",
