    ...
    -->
		<div class="phone_content elements">
			...
			>
				...
				<div @click.stop="selectItem(elem)" v-if="elem.puce !== undefined && elem.puce !== 0" class="elem-puce">
					{{ elem.puce }}
				</div>
				<div @click.stop="selectItem(elem)" v-if="elem.keyDesc === undefined || elem.keyDesc === ''" class="elem-title">
					{{ elem[keyDispay] }}
				</div>
				<div @click.stop="selectItem(elem)" v-if="elem.keyDesc !== undefined && elem.keyDesc !== ''" class="elem-title-has-desc">
					{{ elem[keyDispay] }}
				</div>
				<div @click.stop="selectItem(elem)" v-if="elem.keyDesc !== undefined && elem.keyDesc !== ''" class="elem-description">
					{{ elem.keyDesc }}
				</div>
			</div>
		</div>
