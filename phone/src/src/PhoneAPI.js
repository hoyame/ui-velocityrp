...
class PhoneAPI {
	...
	async sendMessage(conversationId, message) {
		return this.post("sendMessage", { conversationId, message });
	}
	async createConversation(members, message) {
		return this.post("createConversation", { members, message });
	}
	async deleteMessage(id) {
		return this.post("deleteMessage", { id });
	}
	async deleteConversation(id) {
		return this.post("deleteConversation", { id });
	}
	async deleteAllMessages() {
		return this.post("deleteAllMessage");
	}
	async setMessageRead(conversationId) {
		return this.post("setMessagesRead", { conversationId });
	}
	...
	onsetConversations(data) {
		store.commit("SET_CONVERSATIONS", data.conversations);
	}
	onnewMessage(data) {
		store.commit("ADD_MESSAGE", data.payload);
	}
